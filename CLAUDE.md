...
| CAG (JiHy__hylmar__126) | `126697143436` | eu-central-1 | _pending — `mcp-126697143436` IAM ready, connector not yet registered_ |

> CAG is a member of the Hylmar org (`o-8i3fdvbxq7`, master `287773673380`). Until its MCP connector is registered, manage it via assumed `OrganizationAccountAccessRole` from profile `JiHy__hylmar__287`.
